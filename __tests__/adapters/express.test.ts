...
describe('Express Error Handler', () => {
  ...
  describe('Common Error Types', () => {
    it('should handle ValidationError (400) correctly', () => {
      ...
      const errorHandler = createExpressErrorHandler({ includeStackTrace: false, logError: mockLogger });
  ...
  describe('Error Handler Options', () => {
    ...
    it('should include stack trace when includeStackTrace is true', () => {
      ...
      const errorHandler = createExpressErrorHandler({ includeStackTrace: true, logError: mockLogger });
